...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0xc000), LENGTH = (0xf4000 - 0x2000)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x0 + 0xc000);
    rom_start :
 {
HIDDEN(__rom_start_address = .);
FILL(0x00);
. += 0x200 - (. - __rom_start_address);
. = ALIGN(4);
...
bt_gatt_attr_area : ALIGN_WITH_INPUT { _bt_gatt_attr_list_start = .; KEEP(*(SORT_BY_NAME(._bt_gatt_attr.static.*))); _bt_gatt_attr_list_end = .; } > RAM AT > FLASH
    __data_region_end = .;
golioth_downlink_service_area : SUBALIGN(4) { _golioth_downlink_service_list_start = .; KEEP(*(SORT_BY_NAME(._golioth_downlink_service.static.*))); _golioth_downlink_service_list_end = .; } > FLASH
golioth_uplink_service_area : SUBALIGN(4) { _golioth_uplink_service_list_start = .; KEEP(*(SORT_BY_NAME(._golioth_uplink_service.static.*))); _golioth_uplink_service_list_end = .; } > FLASH
golioth_ota_registered_component_area : SUBALIGN(4) { _golioth_ota_registered_component_list_start = .; KEEP(*(SORT_BY_NAME(._golioth_ota_registered_component.static.*))); _golioth_ota_registered_component_list_end = .; } > FLASH
golioth_ota_manifest_handler_area : SUBALIGN(4) { _golioth_ota_manifest_handler_list_start = .; KEEP(*(SORT_BY_NAME(._golioth_ota_manifest_handler.static.*))); _golioth_ota_manifest_handler_list_end = .; } > FLASH
golioth_settings_handler_area : SUBALIGN(4) { _golioth_settings_handler_list_start = .; KEEP(*(SORT_BY_NAME(._golioth_settings_handler.static.*))); _golioth_settings_handler_list_end = .; } > FLASH
 # Copyright (c) 2025 Golioth, Inc.
# SPDX-License-Identifier: Apache-2.0
pouch_downlink_handler_area : SUBALIGN(4) { _pouch_downlink_handler_list_start = .; KEEP(*(SORT_BY_NAME(._pouch_downlink_handler.static.*))); _pouch_downlink_handler_list_end = .; } > FLASH
 # Copyright (c) 2025 Golioth, Inc.
# SPDX-License-Identifier: Apache-2.0
pouch_event_handler_area : SUBALIGN(4) { _pouch_event_handler_list_start = .; KEEP(*(SORT_BY_NAME(._pouch_event_handler.static.*))); _pouch_event_handler_list_end = .; } > FLASH
